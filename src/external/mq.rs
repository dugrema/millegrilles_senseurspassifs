...
pub fn init_queues(mq: &MessagingServiceImpl) -> Result<(), CommonError> {
    ...
    mq.add_named_queue(
        ConfigQueue {
            ...
            routing_keys: vec![
                ConfigRoutingExchange { routing_key: format!("commande.{}.{}", ROLE_RELAI_NOM, COMMANDE_INSCRIRE_APPAREIL), exchange: Securite::L2Prive },
                ConfigRoutingExchange { routing_key: format!("commande.{}.{}", ROLE_RELAI_NOM, COMMANDE_CHALLENGE_APPAREIL), exchange: Securite::L2Prive },
                ConfigRoutingExchange { routing_key: format!("commande.{}.{}", ROLE_RELAI_NOM, COMMANDE_SIGNER_APPAREIL), exchange: Securite::L2Prive },
                ConfigRoutingExchange { routing_key: format!("commande.{}.{}", ROLE_RELAI_NOM, COMMANDE_CONFIRMER_RELAI), exchange: Securite::L2Prive },
                ConfigRoutingExchange { routing_key: format!("commande.{}.{}", ROLE_RELAI_NOM, COMMANDE_RESET_CERTIFICATS), exchange: Securite::L2Prive },
                ConfigRoutingExchange { routing_key: format!("commande.{}.{}", ROLE_RELAI_NOM, COMMAND_DISCONNECT_RELAY), exchange: Securite::L2Prive },
    ...
    mq.add_named_queue(
        ConfigQueue {
            ...
            routing_keys: vec![
                ConfigRoutingExchange { routing_key: format!("commande.{}.{}", ROLE_RELAI_NOM, TRANSACTION_LECTURE), exchange: Securite::L2Prive },
                ConfigRoutingExchange { routing_key: format!("commande.{}.{}", ROLE_RELAI_NOM, TRANSACTION_MAJ_SENSEUR), exchange: Securite::L2Prive },
                ConfigRoutingExchange { routing_key: format!("commande.{}.{}", ROLE_RELAI_NOM, TRANSACTION_MAJ_NOEUD), exchange: Securite::L2Prive },
                ConfigRoutingExchange { routing_key: format!("commande.{}.{}", ROLE_RELAI_NOM, TRANSACTION_SUPPRESSION_SENSEUR), exchange: Securite::L2Prive },
                ConfigRoutingExchange { routing_key: format!("commande.{}.{}", ROLE_RELAI_NOM, TRANSACTION_MAJ_APPAREIL), exchange: Securite::L2Prive },
                ConfigRoutingExchange { routing_key: format!("commande.{}.{}", ROLE_RELAI_NOM, TRANSACTION_SAUVEGARDER_PROGRAMME), exchange: Securite::L2Prive },
                ConfigRoutingExchange { routing_key: format!("commande.{}.{}", ROLE_RELAI_NOM, TRANSACTION_APPAREIL_SUPPRIMER), exchange: Securite::L2Prive },
                ConfigRoutingExchange { routing_key: format!("commande.{}.{}", ROLE_RELAI_NOM, TRANSACTION_APPAREIL_RESTAURER), exchange: Securite::L2Prive },
                ConfigRoutingExchange { routing_key: format!("commande.{}.{}", ROLE_RELAI_NOM, TRANSACTION_MAJ_CONFIGURATION_USAGER), exchange: Securite::L2Prive },
                ConfigRoutingExchange { routing_key: format!("commande.{}.{}", ROLE_RELAI_NOM, TRANSACTION_SHOW_HIDE_SENSOR), exchange: Securite::L2Prive },
